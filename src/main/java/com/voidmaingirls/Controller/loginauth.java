...
try{
        URL url = new URL("https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCk3sGJQj8N4WPm4Bm8aWWKyIxjXLLjVhU");
        ...
        if(responseCode == 200){
            ...
            System.out.println("login failed"+errorResponse.toString());
